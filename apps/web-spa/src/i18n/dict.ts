...
export const ES = {
  ...
  "serie.navegar": "Serie {serie}. Usa las flechas para recorrer los puntos, Inicio y Fin para los extremos, Escape para salir.",
  "historico.ventanaCorta": "{pedidos} d pedidos · {disponibles} d disponibles · percentil calculado sobre {disponibles} d",
  "historico.vacioTitulo": "Sin datos en esta ventana",
  "historico.vacioDetalle": "No hay lecturas de {serie} desde el {fecha}, que es donde empieza el rango pedido.",
  "historico.vacioOficial": "Sin tasa oficial en esta ventana",
  "historico.desfaseOficial": "La tasa oficial llega hasta el {atrasada}; la serie evaluada, hasta el {adelantada} — {dias} d de diferencia.",
  "historico.desfaseSerie": "La serie evaluada llega hasta el {atrasada}; la tasa oficial, hasta el {adelantada} — {dias} d de diferencia.",
  "historico.tipContexto": "percentil {percentil} · {distancia} vs. la mediana",
  "historico.grupoRango": "Rango",
  "historico.grupoSerie": "Serie",
  "historico.grupoBucket": "Bucket",
  "historico.procedencia": "REST /api/v1 · rango máximo 90 días",
  "opcionSerie.brechaCompra": "Brecha compra vs. oficial",
  "opcionSerie.drenaje": "Drenaje de oferta 6 h",
  "opcionSerie.momentum": "Momentum bid 3 h",
  "opcionSerie.ratio": "Ratio oferta / demanda",
  "opcionSerie.spread": "Spread compra-venta",
  "historico.percentilVentana": "percentil {percentil} de {dias} d",
  "historico.stat.minimo": "Mínimo",
  "historico.stat.maximo": "Máximo",
  "historico.stat.mediana": "Mediana",
  "historico.stat.desviacion": "Desviación",
  "historico.statSobre": "sobre {puntos} puntos",
  "historico.oficialBajada": "la pierna que explica el {pct} % del precio · fecha-valor BCV",
  "historico.oficialSinBrecha": "la pierna oficial del precio · fecha-valor BCV",
  "historico.oficialResumen": "{valor} Bs/{moneda} · {fecha}",
  "reglashist.titulo": "Historial de las reglas",
  "reglashist.bajada": "ruleset v1 · {casos} señales emitidas · efecto observado a {horas} h",
  "reglashist.colRegla": "Regla",
  "reglashist.colCasos": "Casos",
  "reglashist.colMedibles": "Con resultado",
  "reglashist.colEfecto": "Efecto medio",
  "reglashist.colMuestra": "Muestra",
  "reglashist.efecto": "{delta} pp a {horas} h",
  "reglashist.sinEfecto": "sin ventana cumplida",
  "reglashist.muestra.sin-casos": "sin casos",
  "reglashist.muestra.hipotesis": "hipótesis",
  "reglashist.muestra.indicativa": "indicativa",
  "reglashist.nota": "El efecto medio es historia observada, no una medida de acierto: dice qué hizo la brecha después, no si la regla acertó. Una regla con una sola aparición se lee como hipótesis y no como patrón, y los umbrales del ruleset v1 salieron del backtest del 11–20 jul y siguen pendientes de recalibración HITL con datos de producción.",
  "episodios.titulo": "Episodios comparables",
  "episodios.bajada": "qué pasó las últimas veces que el libro se parecía al de hoy",
  "episodios.coincidencia": "{pct} % de coincidencia",
  "episodios.colCondicion": "Condición",
  "episodios.colEntonces": "Entonces",
  "episodios.colHoy": "Hoy",
  "episodios.despues": "Qué pasó después",
  "episodios.prosa": "Variación observada de la brecha en las {horas} h siguientes a la señal. Es historia, no una medida de acierto.",
  "episodios.resultado": "{delta} puntos porcentuales",
  "episodios.sinVentana": "La ventana de observación todavía no se ha cumplido: aún no hay nada que contar.",
  "lecthist.titulo": "Lo que dice el histórico",
  "lecthist.ventana": "{dias} días · {desde} – {hasta} · {puntos} puntos de {bucket}",
  "lecthist.veredicto.alta": "{indicador} está en la parte alta de la ventana",
  "lecthist.veredicto.baja": "{indicador} está en la parte baja de la ventana",
  "lecthist.veredicto.centro": "{indicador} se mueve dentro de lo habitual de la ventana",
  "lecthist.prosa.alta": "Hoy queda en el percentil {percentil} de la ventana, {distancia} por encima de la mediana ({mediana}). Un percentil alto no anuncia nada — dice que el valor actual es de los mayores que esta ventana ha recorrido.",
  "lecthist.prosa.baja": "Hoy queda en el percentil {percentil} de la ventana, {distancia} respecto de la mediana ({mediana}). Un percentil bajo no anuncia nada — dice que el valor actual es de los menores que esta ventana ha recorrido.",
  "lecthist.prosa.centro": "Hoy queda en el percentil {percentil} de la ventana, a {distancia} de la mediana ({mediana}). Estar en el centro de la distribución significa que el valor actual no destaca sobre lo que esta ventana ya había recorrido.",
  "lecthist.anclaPercentil": "Percentil de hoy",
  "lecthist.anclaMediana": "Distancia a la mediana",
  "lecthist.anclaCruce": "Días desde el último cruce",
  "lecthist.detallePercentil.alta": "en el 10 % superior de la ventana",
  "lecthist.detallePercentil.baja": "en el 10 % inferior de la ventana",
  "lecthist.detallePercentil.centro": "dentro del 80 % central",
  "lecthist.detalleMediana": "mediana de la ventana: {mediana}",
  "lecthist.detalleCruceSinRegla": "el indicador no participa en ninguna regla",
  "lecthist.detalleCruceNinguno": "toda la ventana del mismo lado del umbral",
  "lecthist.detalleCruceDias": "último cambio de lado del umbral",
...
export const EN: Record<Clave, string> = {
  ...
  "serie.navegar": "Series {serie}. Use the arrow keys to move through the points, Home and End for the ends, Escape to exit.",
  "historico.ventanaCorta": "{pedidos} d requested · {disponibles} d available · percentile computed over {disponibles} d",
  "historico.vacioTitulo": "No data in this window",
  "historico.vacioDetalle": "No readings of {serie} since {fecha}, where the requested range starts.",
  "historico.vacioOficial": "No official rate in this window",
  "historico.desfaseOficial": "The official rate reaches {atrasada}; the evaluated series, {adelantada} — {dias} d apart.",
  "historico.desfaseSerie": "The evaluated series reaches {atrasada}; the official rate, {adelantada} — {dias} d apart.",
  "historico.tipContexto": "percentile {percentil} · {distancia} vs. the median",
  "historico.grupoRango": "Range",
  "historico.grupoSerie": "Series",
  "historico.grupoBucket": "Bucket",
  "historico.procedencia": "REST /api/v1 · 90-day maximum range",
  "opcionSerie.brechaCompra": "Buy gap vs. official",
  "opcionSerie.drenaje": "Supply drain 6 h",
  "opcionSerie.momentum": "Bid momentum 3 h",
  "opcionSerie.ratio": "Supply / demand ratio",
  "opcionSerie.spread": "Buy-sell spread",
  "historico.percentilVentana": "percentile {percentil} of {dias} d",
  "historico.stat.minimo": "Minimum",
  "historico.stat.maximo": "Maximum",
  "historico.stat.mediana": "Median",
  "historico.stat.desviacion": "Deviation",
  "historico.statSobre": "over {puntos} points",
  "historico.oficialBajada": "the leg that explains {pct}% of the price · BCV value date",
  "historico.oficialSinBrecha": "the official leg of the price · BCV value date",
  "historico.oficialResumen": "{valor} Bs/{moneda} · {fecha}",
  "reglashist.titulo": "Rule history",
  "reglashist.bajada": "ruleset v1 · {casos} signals emitted · effect observed at {horas} h",
  "reglashist.colRegla": "Rule",
  "reglashist.colCasos": "Cases",
  "reglashist.colMedibles": "With outcome",
  "reglashist.colEfecto": "Mean effect",
  "reglashist.colMuestra": "Sample",
  "reglashist.efecto": "{delta} pp at {horas} h",
  "reglashist.sinEfecto": "window not elapsed",
  "reglashist.muestra.sin-casos": "no cases",
  "reglashist.muestra.hipotesis": "hypothesis",
  "reglashist.muestra.indicativa": "indicative",
  "reglashist.nota": "The mean effect is observed history, not a hit rate: it says what the gap did afterwards, not whether the rule was right. A rule with a single appearance reads as a hypothesis and not as a pattern, and the ruleset v1 thresholds came from the 11–20 Jul backtest and are still pending HITL recalibration with production data.",
  "episodios.titulo": "Comparable episodes",
  "episodios.bajada": "what happened the last times the book looked like today's",
  "episodios.coincidencia": "{pct}% match",
  "episodios.colCondicion": "Condition",
  "episodios.colEntonces": "Then",
  "episodios.colHoy": "Today",
  "episodios.despues": "What happened next",
  "episodios.prosa": "Observed change in the gap over the {horas} h after the signal. This is history, not a hit rate.",
  "episodios.resultado": "{delta} percentage points",
  "episodios.sinVentana": "The observation window has not elapsed yet: there is nothing to report.",
  "lecthist.titulo": "What the history says",
  "lecthist.ventana": "{dias} days · {desde} – {hasta} · {puntos} {bucket} points",
  "lecthist.veredicto.alta": "{indicador} sits in the upper part of the window",
  "lecthist.veredicto.baja": "{indicador} sits in the lower part of the window",
  "lecthist.veredicto.centro": "{indicador} moves within the window's usual range",
  "lecthist.prosa.alta": "Today lands at percentile {percentil} of the window, {distancia} above the median ({mediana}). A high percentile announces nothing — it says the current value is among the highest this window has covered.",
  "lecthist.prosa.baja": "Today lands at percentile {percentil} of the window, {distancia} from the median ({mediana}). A low percentile announces nothing — it says the current value is among the lowest this window has covered.",
  "lecthist.prosa.centro": "Today lands at percentile {percentil} of the window, {distancia} from the median ({mediana}). Sitting in the middle of the distribution means the current value does not stand out against what this window had already covered.",
  "lecthist.anclaPercentil": "Today's percentile",
  "lecthist.anclaMediana": "Distance to median",
  "lecthist.anclaCruce": "Days since last crossing",
  "lecthist.detallePercentil.alta": "in the window's top 10%",
  "lecthist.detallePercentil.baja": "in the window's bottom 10%",
  "lecthist.detallePercentil.centro": "within the central 80%",
  "lecthist.detalleMediana": "window median: {mediana}",
  "lecthist.detalleCruceSinRegla": "the indicator takes part in no rule",
  "lecthist.detalleCruceDias": "last change of side of the threshold",
  "lecthist.detalleCruceNinguno": "whole window on the same side of the threshold",

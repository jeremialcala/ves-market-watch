...
2. Todos los casos de las secciones 5–7 aplicables al alcance entregado, en verde.
   **Cumplido**: 1 238 tests en verde, los seis proyectos, en cada push desde el
...
- **`ci.yml` — matriz por app:** los cinco servicios Python y el `web-spa`, en
  ...
  Sin filtros por ruta: 1 238 tests son baratos y un filtro mal puesto da verdes
  vacíos.

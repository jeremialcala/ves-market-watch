...
| Pendientes marcados para fase 03 | ⚠️ | Resueltos en fase 03: spike endpoint P2P ✔ (ADR-0005), bundle TLS BCV ✔ (ADR-0006), JSON Schemas de eventos ✔ (3 de 4 en `schemas/`; `p2p-snapshot` ya en v1.1 con `merchant_ref`, ADR-0011), identidad de anunciantes ✔ (ADR-0011 implementado 2026-07-06). Siguen abiertos: `signal.v1` y umbrales de señales (fase de señales del engine, HITL — la fase 2 P2P/microestructura ya se entregó 2026-07-20 sin el evento de señales), secret store concreto (fase 05) |
